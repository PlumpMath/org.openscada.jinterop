...
public interface IJIWinReg
{
     ...
     * estimated expected value. In this case
     * 1024 would do.
     * 
     * @param handle
     * @param bufferSize
     ...
     *         contains the value as a 1 dimensional byte array,if any. In case
     *         of REG_MULTI_SZ
     ...
     * in the registry when the machine shutsdown, otherwise it is stored only
     * in memory.
     * 
     * @param handle
     * @param subKey
     ...
     * each primary dimension representing
     * one string. Please make sure that the encoding is correct while doing
     * String.getBytes(...).
     * 
     * @param handle
     * @param valueName
     ...
     * be considered as String if the binary flag is not set to true.
