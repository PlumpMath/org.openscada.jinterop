...
public class JIObjectFactory
{
     ...
     * 
     * @param comObject
     *            object to which the listener will be attached.
     * @param sourceUUID
     *            <code>IID</code> of the call back interface.
     * @param eventListener
     *            <code>IJIComObject</code> obtained using
     *            {@link #buildObject(JISession, JILocalCoClass)}
     * @return string identifier for this connection, please save this for
     *         eventual release using
     *         {@link #detachEventHandler(IJIComObject, String)}
     * @throws JIException
     ...
     * 
     * @param session
     *            session to attach <code>comObject</code> to.
     * @param javaComponent
     * @return
     * @throws JIException
     */
     ...
     * 
     * @param session
     *            session to attach <code>comObject</code> to. If required the
     *            framework will create a new session
     *            for this <code>comObject</code> and link the
     *            <code>session</code> to the new one. This new session will be
     ...
     *            machine, overriding the other IP addresses
     *            present in the interface pointer. If this IP is not found then
     *            the "machine name" binding will be used. If this param is
     *            <code>null</code> then the first
