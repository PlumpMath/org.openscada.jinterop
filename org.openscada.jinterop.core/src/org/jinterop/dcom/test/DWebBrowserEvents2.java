...
public class DWebBrowserEvents2
{
    ...
    public JIVariant BeforeNavigate2 ( IJIComObject dispatch, JIVariant URL, JIVariant Flags, JIVariant TargetFrameName, JIVariant PostData, JIVariant Headers, JIVariant Cancel ) throws JIException
    {
    ...
    public JIVariant NewWindow2 ( JIVariant ppDisp, JIVariant Cancel ) throws JIException
    {
    ...
    public void NavigateComplete2 ( IJIComObject pDisp, JIVariant URL ) throws JIException
    {
    ...
    public void DocumentComplete ( IJIComObject pDisp, JIVariant URL ) throws JIException
    {
    ...
    public JIVariant WindowClosing ( boolean IsChildWindow, JIVariant Cancel ) throws JIException
    {
    ...
    public Integer[] ClientToHostWindow ( int CX, int CY )
    {
    ...
    public JIVariant NavigateError ( IJIComObject pDisp, JIVariant URL, JIVariant Frame, JIVariant StatusCode, JIVariant Cancel ) throws JIException
    {
    ...
    public void UpdatePageStatus ( IJIComObject pDisp, JIVariant nPage, JIVariant fDone )
    {
    ...
    public JIVariant NewWindow3 ( JIVariant ppDisp, JIVariant Cancel, int dwFlags, JIString bstrUrlContext, JIString bstrUrl ) throws JIException
    {
    ...
    public void WindowStateChanged ( int dwWindowStateFlags, int dwValidFlagsMask )
    {
