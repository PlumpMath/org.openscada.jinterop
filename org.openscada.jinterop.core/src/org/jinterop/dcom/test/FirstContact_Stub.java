...
public class FirstContact_Stub implements FirstContact
{
    ...
    public void obtainReference ()
    {
        try
        {
            ...
            ret0 = dispatch.callMethodA ( "ReadAsicRegisterBlock", new Object[] { new JIString ( "Chonap" ), new JIString ( "Cho" ), new JIVariant ( new JIArray ( new JIUnsignedShort[] { (JIUnsignedShort)JIUnsignedFactory.getUnsigned ( new Integer ( 4000 ), JIFlags.FLAG_REPRESENTATION_UNSIGNED_SHORT ), (JIUnsignedShort)JIUnsignedFactory.getUnsigned ( new Integer ( 4001 ), JIFlags.FLAG_REPRESENTATION_UNSIGNED_SHORT ) }, true ), true ), new JIVariant ( new JIArray ( new JIUnsignedInteger[] { (JIUnsignedInteger)JIUnsignedFactory.getUnsigned ( new Long ( 9999 ), JIFlags.FLAG_REPRESENTATION_UNSIGNED_INT ), (JIUnsignedInteger)JIUnsignedFactory.getUnsigned ( new Long ( 9999 ), JIFlags.FLAG_REPRESENTATION_UNSIGNED_INT ) }, true ), true ), Boolean.FALSE, Boolean.TRUE } );
            ...
            ret01 = ( (JIVariant)ret0[1] ).getObjectAsArray ();
            ret0 = dispatch.callMethodA ( "testSA2", new Object[] { new JIVariant ( new JIArray ( new Byte[] { new Byte ( (byte)1 ), new Byte ( (byte)1 ) }, true ), true ), new JIVariant ( new JIArray ( new JIVariant[] { new JIVariant ( dispatch, true ) }, true ), true ), new JIVariant ( new JIArray ( new JIVariant[] { new JIVariant ( unknown, true ) }, true ), true ) } );
            ret01 = ( (JIVariant)ret0[1] ).getObjectAsArray ();
            ret01 = ( (JIVariant)ret0[2] ).getObjectAsArray ();
            ret01 = ( (JIVariant)ret0[3] ).getObjectAsArray ();
