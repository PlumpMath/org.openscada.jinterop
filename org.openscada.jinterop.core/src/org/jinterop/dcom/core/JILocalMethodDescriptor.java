 ...
 * implementations.
 * Framework uses java reflection to invoke methods requested by COM clients so
 * it is
 * absolutely essential that java methods in the implementation class conform
 * exactly to
...
public final class JILocalMethodDescriptor
{
     ...
     * added to the <code>JILocalInterfaceDefinition</code>. This number is
     * incremented by 1 for each subsequent
     ...
     *            name of the method.
     * @param dispId
     *            <code>DISPID</code> of this method as in the <code>IDL</code>
     *            or the TypeLibrary.
     * @param parameters
     *            pass <code>null</code> if the method has no parameters.
     */
