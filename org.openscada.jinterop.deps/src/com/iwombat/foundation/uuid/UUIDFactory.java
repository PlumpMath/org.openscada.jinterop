 ...
 * algorythm. Since java supplies no
 * mechanism for this ObjectId looks for a MACADDR system property consisting of
 * a hex string of six bytes ( a 12
 * character hex string - no delimiters and no 0x token ). Failing to find said
 * system property ObjectId generates a
 * random MACADDR and uses the last octet of the ip address as the last octet in
 * the MACADDR to guarantee unequeness on
