...
public interface IRandom extends Cloneable
{
     ...
     *                theoretical limit for generating non-repetitive
     *                pseudo-random data.
     */
     ...
     * @param offset
     *            the starting index in <i>out</i> to consider. This method
     *            does nothing if this parameter is not within <code>0</code>
     *            and <code>out.length</code>.
     * @param length
