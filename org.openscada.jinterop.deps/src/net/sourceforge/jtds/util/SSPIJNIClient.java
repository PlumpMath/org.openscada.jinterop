...
public class SSPIJNIClient
{
    ...
    private SSPIJNIClient ()
    {
        ...
        catch ( UnsatisfiedLinkError err )
        {
            ...
            throw new IllegalStateException ( "Native SSPI library not loaded. " + "Check the java.library.path system property." + "This functionality is available only under \"Microsoft Windows\" line of Operating systems." );
